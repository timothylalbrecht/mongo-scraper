...
// mongoose.connect("mongodb://localhost/testscrape", { useNewUrlParser: true });
var MONGODB_URI = process.env.MONGODB_URI || "mongodb://localhost/mongoBBC";
...
app.get("/scrape", function(req, res) {
  ...
  axios.get("http://www.bbc.com/").then(function(response) {
    ...
    $("div.media__content").each(function(i, element) {
      ...
      result.summary = $(this).children('p.media__summary').text().trim();
